    ...
    {        
        ...
        {            
            string stringinsert = "insert into Tbl_Associados (Nome,Apelido,Endereco,CEP,Bairro,Cidade ,UF,Filiacao_Pai,Filiacao_Mae, " +
                ...
                "NIT,CEI,Estado_Civil , Telefone ,email , sexo,CTPS ,RGP ,RGP_Registro ,RGP_emissor, " +
                "Profissao, Categoria ,AreaAtuacao , Relacao_Trabalho , Embarcacao_Utiliza , Embarcacao_Nome , Embarcacao_Prop ,Embarcacao_Tipo ,Embarcacao_Tamanho ,Embarcacao_PRopulsao, " +
                "Embarcacao_capitania ,RGP_MPA ,Arte_Principal , Arte_Quant,Arte_Dono ,Arte_Esepcies ,Arte_locais_venda , Arte_comercializado , Trabalho_dias , Trabalho_duracao, " +
                "Trabalho_producao ,Trabalho_valor_venda ,Trabalho_consumido ,Dependentes , Filhos_Escola , Seguro_Defeso , Bolsa_Familia, Tipo_Resid ,possui_Agua_Encanada , possui_Energia , " +
                "possui_Telefone , possui_esgoto ,possui_computador , pessoas_Resid , pessoas_Menores ,pessoas_aposentados , renda_mensal, outra_atividade ,  renda_outra , valor_Seguro_desemprego ," +
                "valor_bolsa_familia ,total_renda_familiar , tempo_associado ,mensalidade_em_dias ,valor_mensalidade ,motivo_inadimp , satisfeito ,opniao , FotoDataURI ,   " +
